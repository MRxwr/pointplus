...
import 'package:point/presentation/main/compare_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    double height = ScreenUtil().screenHeight-70-appBarHeight-90.h;
                ...
                itemBuilder: (context, index) {
                  return GestureDetector(
                    onTap: (){
                      ...
                      String selecetedUserId= leaderBordList[index].id.toString();
                      if(currentUserId!= selecetedUserId) {
                        Navigator.of(context, rootNavigator: true).push(
                            MaterialPageRoute(builder: (BuildContext context) {
                              return CompareScreen(
                                userId: id!,
                                comparedUserId: leaderBordList[index].id.toString(),
                              );
                            }));
                      }
                    },
                    child: leaderBordList[index].id == id?Container(
                      height: AppSize.s50,
                                    ...
                                    Positioned.directional(textDirection: Directionality.of(context),
                                        ...
                                        child: Center(
                                          child: Container(
                                            ...
                                            child: Text(
                                              matches![index].stadium.toString(),
                                              textAlign: TextAlign.center,
                                              style: TextStyle(
                                                color: Colors.white,
                                                fontWeight: FontWeight.normal,
