...
class ChatContainer extends StatelessWidget {
  ...
  Widget _buildMessage(BuildContext context, Message message,BattleRoom battleRoom) {
  ...
  @override
  Widget build(BuildContext context) {
    BattleRoom battleRoom = (context.read<MultiUserBattleRoomCubit>().state as MultiUserBattleRoomSuccess).battleRoom;
          ...
          return messages.isEmpty
              ...
              : ListView.builder(
                  ...
                  itemBuilder: (context, index) {
                    return _buildMessage(context, messages[index],battleRoom);
                  },
                );
        }
        return const SizedBox();
