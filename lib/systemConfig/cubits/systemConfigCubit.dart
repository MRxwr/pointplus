...
class SystemConfigCubit extends Cubit<SystemConfigState> {
  ...
  Future<void> getSystemConfig() async {
    ...
    try {
      ...
      final systemConfig = await _systemConfigRepository.getSystemConfig("assets/files/system_config.json");
      ...
      if (systemConfig.languageMode) {
        supportedLanguages =
            await _systemConfigRepository.getSupportedQuestionLanguages("assets/files/language.json");
      }
      emit(
        SystemConfigFetchSuccess(
