...
<input type="text" class="form-control" id="exampleInputuname_1" placeholder="" name="startDate" <?php if(isset($_GET["edit"])){?>value="<?php echo $data[0]["startDate"] ?>"<?php }?> required>
</div>
</div>
</div>
...
<div class="input-group">
<div class="input-group-addon"><i class="fa fa-text-width"></i></div>
<input type="text" class="form-control" id="exampleInputuname_1" placeholder="" name="endDate" <?php if(isset($_GET["edit"])){?>value="<?php echo $data[0]["endDate"] ?>"<?php }?> required>
</div>
</div>
</div>
