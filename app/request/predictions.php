...
if( isset($_GET["type"]) && !empty($_GET["type"]) ){
	...
	if( $_GET["type"] == "list" ){
		$data = array(
			"select" => ["t.id as matchId, t.type, t1.enTitle as enTitleTeam1, t1.arTitle as arTitleTeam1, t1.logo as logoTeam1, t2.enTitle as enTitleTeam2, t2.arTitle as arTitleTeam2, t2.logo as logoTeam2, t3.arTitle as leagueAr, t3.enTitle as leagueEn"],
